...
var compress = function (chars) {
  ...
  for (let x = 0; x < chars.length; x++) {
    ...
    if (current != next) { // change detected
      out.push(current)
...
describe('compress', () => {
  it('handles example 1', () => {
    assert.deepEqual(compress(["a", "a", "b", "b", "c", "c", "c"]), ["a", "2", "b", "2", "c", "3"])
  })
  ...
  it('handles example 3', () => {
    assert.deepEqual(compress(["a", "b", "b", "b", "b", "b", "b", "b", "b", "b", "b", "b", "b"]), ["a", "b", "1", "2"])
  })
})
